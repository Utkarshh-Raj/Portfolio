                ...
                <div className="main-skills">
                    <div className="webdev">
                        <div className="webd-card">
                            ...
                            <p className="webd-item">HTML5<span className='skill-icon'><i className="fa-brands fa-html5"></i></span></p>
                            <p className="webd-item">CSS3<span className='skill-icon'><i className="fa-brands fa-css3-alt"></i></span></p>
                    ...
                    <div className="languages">
                        <div className="lang-card">
                            ...
                            <p className="lang-item">PYTHON</p>
